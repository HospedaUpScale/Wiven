      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li><strong>Dados de credenciamento ao sistema:</strong> nome completo, firma ou denominação social, número de CPF/MF, número de telefone, endereço de residência ou sede, filiação, endereço de e-mail.</li>
              ...
              <li><strong>Recrutamento e seleção:</strong> nome, foto, e-mail, dados para contato e informações relacionadas à carreira.</li>
              <li><strong>Atendimento de suporte:</strong> nome, e-mail, CPF e outras informações relacionadas à demanda.</li>
              <li><strong>Marketing digital:</strong> nome, e-mail e telefone.</li>
